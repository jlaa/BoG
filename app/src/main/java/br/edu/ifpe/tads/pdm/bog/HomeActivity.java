...
public class HomeActivity extends AppCompatActivity {
    ...
    public void setGames() {
        /*private static final Games [] games = {"League of legends", "Paladins", "Overwatch", "Mortal Kombat",
            ...
            "Super Mario World"};*/
        arrayList.add(new Games("League of Legends", 5, "Moba", "League of Legends é um jogo eletrônico do gênero multiplayer online battle arena, desenvolvido e publicado pela Riot Games. Um estilo moba como você nunca viu antes"));
