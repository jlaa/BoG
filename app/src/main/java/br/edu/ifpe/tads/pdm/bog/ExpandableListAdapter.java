...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, Games> _listDataChild;

    public ExpandableListAdapter(Context context, List<String> listDataHeader,
                                 HashMap<String, Games> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final Games child = (Games) getChild(groupPosition, childPosition);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.list_games_names, null);
        }
